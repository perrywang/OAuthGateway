package org.thinkinghub.gateway.core.builder;


import java.io.OutputStream;

import org.thinkinghub.gateway.core.builder.api.BaseApi;
...
public class ServiceBuilder {
    ...
    public ServiceBuilder appID(String appID){
    	Preconditions.checkEmptyString(appID, "Invalid App ID");
        this.appID = appID;
        return this;
    }
    ...
    private OAuthConfig createConfig() {
        checkPreconditions();
        return new OAuthConfig(apiKey, apiSecret, callback, scope, debugStream, state, responseType,
                userAgent, connectTimeout, readTimeout);
    }
